...
public class Employee {
	...
	/*
	 * public Employee(String firstName, String lastName, int age, Address
	 * address, List<PhoneNumber> numbers) { this.firstName = firstName;
	 * this.lastName = lastName; this.age = age; this.address = address;
	 ...
	 * 
	 * public void setNumbers() { this.numbers = numbers; }
	 * 
	 * public List<PhoneNumber> getNumbers() { return numbers; }
	 * 
	...
	class Address {
		...
		/*
		 * public void setStreetAddress() { this.streetAddress = streetAddress;
		 * }
		 * 
		 ...
		 * 
		 * public void setPostalCode() { this.postalCode = postalCode; }
		 * 
